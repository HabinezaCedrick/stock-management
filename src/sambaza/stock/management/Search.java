      ...
      String ProductID = search.getText();
       model.setRowCount(0);
        ...
        try{
            ...
            ResultSet rs = st.executeQuery("select * from product where ProductID = '"+search.getText()+"'");
           
            while(rs.next()){
             
             
            model.addRow(new Object[] {rs.getString("ProductID"),rs.getString("ProductName"),rs.getString("Price"),rs.getString("Quantity")});
        
            }
            }
        catch(Exception e){
            JOptionPane.showMessageDialog(null,"cc"+e.getMessage());
        }
